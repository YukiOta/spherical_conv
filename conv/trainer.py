...
class Trainer:
    ...
    def train_step(self):
        # train_size の中から、batch_sizeの数だけ値を持ってくる
        ...
        # print('Batch taking  {0}'.format(elapsed) + '[sec]')
        ...
        elapsed = time.time() - start
        print('Gradient taking  {0}'.format(elapsed) + '[sec]')
        ...
        if self.current_iter % self.iter_per_epoch == 0:
            ...
            elapsed = time.time() - start
            print('acc taking  {0}'.format(elapsed) + '[sec]')
    ...
    def train(self):
        ...
        print("iterarion per epoch:", self.iter_per_epoch)
